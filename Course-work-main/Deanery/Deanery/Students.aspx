        ...
        <div style="height: 576px">
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="Id_stud" AllowSorting="True" AllowPaging="True" CellPadding="5" Height="93%" HorizontalAlign="Left" Width="70%">
                <Columns>
                    ...
                    <asp:BoundField DataField="Addres" HeaderText="Адрес" SortExpression="Addres" />
                    <asp:BoundField DataField="Tel" HeaderText="Телефон" SortExpression="Tel" />
                    <asp:BoundField DataField="Date_birth" HeaderText="Дата рождения" SortExpression="Date_birth" />
                </Columns>
